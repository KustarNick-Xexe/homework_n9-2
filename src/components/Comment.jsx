...
const Comment = () => {
  return (
    <div className="flex bg-white w-600 p-4 mb-4 border border-slate-300 rounded-b-lg shadow-sm shadow-slate-300 relative">
      <div className='w-8 h-8 bg-slate-500 rounded-full mr-4'></div>
      <input 
        type="text" 
        className='w-full h-8 bg-slate-200 border border-slate-400 rounded-full outline-none pl-4'
        placeholder='Напишите комментарий...'/>
      <div className='flex absolute right-8 top-6 gap-1'>
